  ...
  return (
    <div className='flex h-16 lg:h-screen bg-arian-negro border-r border-arian-grisclaro box-border'>
      <div className='flex lg:block h-4/4 w-full lg:w-20 lg:hover:w-24 lg:ease-in lg:duration-300'>
        ...
        {/* Linkedin */}
        <div className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 ease-in duration-300 text-transparent hover:text-arian-blanco'>
          <div className='w-full text-center justify-center'>
