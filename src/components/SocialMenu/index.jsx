  ...
  return (
    <div className='flex h-16 lg:h-screen bg-arian-negro border-r border-arian-grisclaro box-border'>
      <div className='flex lg:block h-4/4 w-full lg:w-20 lg:hover:w-24 lg:ease-in lg:duration-300'>
        {/* Download */}
        <div className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 text-transparent hover:text-arian-blanco ease-in duration-300'>
        ...
        {/* Email */}
        <a href='mailto:arianfernandez@gmail.com' className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 text-transparent hover:text-arian-blanco ease-in duration-300'>
          <div className='w-full text-center justify-center'>
        ...
        {/* Linkedin */}
        <a href='https://www.linkedin.com/in/arian-noel/' target='_blank' className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 ease-in duration-300 text-transparent hover:text-arian-blanco' rel='noreferrer'>
          <div className='w-full text-center justify-center'>
        ...
        {/* Github */}
        <a href='https://github.com/arianf30' target='_blank' className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 ease-in duration-300 text-transparent hover:text-arian-blanco' rel='noreferrer'>
          <div className='w-full text-center justify-center'>
        ...
        {/* Instagram */}
        <a href='https://www.instagram.com/arian.noel/' target='_blank' className='flex w-1/5 lg:h-1/5 lg:w-full justify-center items-center cursor-pointer fill-arian-grisclaro hover:fill-arian-blanco2 ease-in duration-300 text-transparent hover:text-arian-blanco' rel='noreferrer'>
          <div className='w-full text-center justify-center'>
